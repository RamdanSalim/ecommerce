...
class ApiQuery {
  ...
  Future<Response?> postQuery(String url, Map<String, String> headers,
    ...
    try {
      ...
      response =
          await dio.post(ApiConst.baseUrl + url, data: data, options: options);
      return response;
  ...
  Future<Response?> putQuery(String url, Map<String, String> headers,
    ...
    try {
      ...
      log(ApiConst.baseUrl + url);
      response =
          await dio.put(ApiConst.baseUrl + url, data: data, options: options);
      return response;
    } on DioError catch (exception) {
      if (exception.toString().contains('SocketException')) {
        return exception.response;
    ...
    try {
      ...
      if (isBaseUrlToBeAdded) {
        if (isCached) {
          ...
          response = await dio.get(ApiConst.baseUrl + url,
  ...
  Future<Response?> patchQuery(
    ...
    try {
      ...
      if (isBaseUrlToBeAdded) {
        response = await dio.patch(ApiConst.baseUrl + url, data: data);
      } else {
  ...
  Future<Response?> logoutQuery(String url, dynamic data) async {
    ...
    try {
      ...
      response = await dio.post(ApiConst.baseUrl + url, data: data);
      dio.clear();
  ...
  Future<Response?> deleteQuery(String url, Map<String, String> headers,
    ...
    try {
      ...
      if (isBaseUrlToBeAdded) {
        response = await dio.delete(ApiConst.baseUrl + url,
